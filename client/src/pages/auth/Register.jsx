        ...
        <div className='w-full min-h-screen flex justify-center items-center bg-black'>
            <form className='bg-gray-800 shadow-lg p-8 rounded-lg flex flex-col justify-center items-center gap-4 min-w-[400px] min-h-[500px]' onSubmit={handleSubmit}>
                ...
                <div className="inputfield flex flex-col w-full">
                    ...
                    <select name="role" value={role} onChange={(e) => setRole(e.target.value)} className="border-[1px] border-gray-600 rounded-lg bg-transparent p-2 text-white">
                        {/* <options disabled >{role ? role : "Client"}</options> */}
                        <option className='bg-gray-600 text-white' value="client">Client</option>
                        <option className='bg-gray-600 text-white' value="caretaker">CareTaker</option>
                        <option className='bg-gray-600 text-white' value="health expert">Health Expert</option>
                    </select>
                </div>
